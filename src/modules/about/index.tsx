            ...
            <div className="w-5/6 md:w-2/3 lg:w-2/3 flex flex-col justify-center items-center gap-10 mt-10 md:mt-0 lg:mt-0">
                ...
                <div className="w-full flex flex-col md:flex-row lg:flex-row justify-center items-start gap-10">
                    <div className="w-full text-center">
                        <h1 className="text-2xl font-bold text-[rgb(var(--primary-rgb))] mb-5">Lịch Sử Hình Thành & Phát Triển</h1>
                    ...
                    <div className="w-full text-center">
                        <h1 className="text-2xl font-bold text-[rgb(var(--primary-rgb))] mb-5">Tầm Nhìn & Sứ Mệnh</h1>
                        <p className="text-md text-[rgb(var(--quaternary-rgb))]">
                ...
                <div className="w-full flex flex-col md:flex-row lg:flex-row justify-center items-start gap-10">
                    <div className="w-full text-center">
                        <h1 className="text-2xl font-bold text-[rgb(var(--primary-rgb))] mb-5">Giá Trị Cốt Lõi</h1>
                        <p className="text-md text-[rgb(var(--quaternary-rgb))]">
                    ...
                    <div className="w-full text-center">
                        <h1 className="text-2xl font-bold text-[rgb(var(--primary-rgb))] mb-5">Quy Mô & Cơ Sở Vật Chất</h1>
                        <p className="text-md text-[rgb(var(--quaternary-rgb))]">
