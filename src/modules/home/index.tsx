    ...
    <div className="w-full min-h-screen flex flex-col justify-start items-center relative">
      ...
      <div className="w-full bg-[rgb(var(--quaternary-rgb))] flex items-center justify-center">
        <div className="w-2/3 py-6 flex flex-col lg:flex-row items-center justify-end gap-4">
          <h1 className="hidden lg:flex text-[16px] text-white font-semibold">
            ECOKA HANDICRAFTS
          </h1>
            ...
            {isMobile ? (
              <div className="dropdown-container relative ">
                <div
                  ...
                  className="px-2 py-1 flex flex-row justify-center items-center gap-1 bg-opacity-60 bg-white cursor-pointer rounded-lg"
                >
                  <Image
      ...
      <div className="w-full relative">
        <video
          className="w-full h-[680px] md:h-[1000px] lg:h-[1000px] object-cover"
          autoPlay
          loop
          muted
        >
        ...
        <div className="w-full absolute top-0 pt-6 flex flex-col justify-center items-center gap-10 text-white">
          <nav className="w-full hidden lg:flex flex-row justify-center items-center gap-4 py-6 uppercase">
            <Link
              href={`/${lang}/`}
              className="bg-gray-50 bg-opacity-60 text-[20px] text-[rgb(var(--quaternary-rgb))] font-bold px-4 py-2 rounded-lg h-full flex items-center justify-center hover:bg-[rgb(var(--quaternary-rgb))] hover:opacity-70 hover:text-white"
            >
            ...
            <div className="relative group h-full">
              ...
              <div className="absolute top-full left-0 flex flex-col gap-3 mt-2 w-64 p-5 pl-7 bg-white opacity-80 text-black shadow-lg rounded-lg transform scale-0 group-hover:scale-100 transition-transform duration-500 ease-in-out">
                {categories.map((category: any, index: number) => (
                  <Link
                    href={`/${lang}${ROUTES.PRODUCT}${category.path}`}
                    className="text-lg font-semibold transform duration-300 hover:scale-110"
                  >
          ...
          <img
            className="w-28 h-28 lg:w-44 lg:h-44 object-cover mt-10 md:mt-0 lg:mt-0"
            src={IMAGES?.LOGO_CIRCLE}
            alt="logo"
          />
          <h1 className="text-[22px] lg:text-[60px] font-black">
            {dictionary?.HOME_title}
          </h1>
          <div className="text-center flex flex-col items-center gap-4 px-8">
            <h1 className="text-[14px] w-full md:w-3/4 lg:w-3/4 lg:text-[20px] font-light">
              {dictionary?.HOME_description}
            </h1>
          </div>
          <Link
            href={`/${lang}${ROUTES.PRODUCT}`}
            className="flex flex-row justify-center items-center py-2 bg-[rgb(var(--primary-rgb))] rounded-lg text-[12px] md:text-[14px] lg:text-[14px] font-medium px-6 hover:bg-[rgb(var(--primary-rgb))] hover:opacity-80"
          >
            {dictionary?.HOME_discovery}{" "}
