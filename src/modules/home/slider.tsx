...
export function Slider() {
    ...
    const [slidesData, setSlidesData] = useState([
        ...
        { id: "03", image: IMAGES.PRODUCT_14_MAIN, title: 'Lồng Mèo Handmade', roomType: 'Nội Thất' },
    ...
    return (
        <div className="flex flex-col md:grid md:grid-cols-5 lg:grid lg:grid-cols-5">
            <div className="col-span-2 md:p-10 lg:p-10 flex flex-col justify-center">
                <div className="text-black text-3xl font-bold mb-2 text-clip overflow-hidden text-center md:text-start lg:text-start">50+ Sản phẩm thân thiện với môi trường</div>
